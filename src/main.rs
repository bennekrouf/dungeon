...
mod prelude {
    ...
    pub const DISPLAY_WIDTH: i32 = SCREEN_WIDTH / SPLIT;
    pub const DISPLAY_HEIGHT: i32 = SCREEN_HEIGHT / SPLIT;
    pub use crate::map::*;
...
fn main() -> BError {
    ...
    .with_font("terminal8*8", 8, 8)
    .with_simple_console(DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont.png")
    .with_simple_console_no_bg(DISPLAY_WIDTH, DISPLAY_HEIGHT, "dungeonfont.png")
    .with_simple_console_no_bg(SCREEN_WIDTH * 2, SCREEN_HEIGHT * 2, "terminal8*8.png")
    .build()?;
